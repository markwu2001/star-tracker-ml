import sys
import os
# Do not run the function here. Call in top level ml_model_generation_pipeline.ipynb
...
def binning_feature_extraction(centroid_filepath, bin_filepath, bin_filename):
